...
$newUserFile          = new File($userFilename);
// $transfer             = new Transaction(new File($transactionFilename),new User($newUserFile),[],$helpers);
// $transfer->storeTransaction();
$transfer             = new Transaction($newDB,new User($newDB),[],$helpers);
$transfer->storeTransaction();
?>
